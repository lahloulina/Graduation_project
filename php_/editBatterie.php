...
<html lang="fr">
  <head>
    ...
    <?php
      ...
      ?>
        <form id="batterieForm" method="post" onSubmit="return checkform_Recharge_Batterie()" class="formulaireEdit">
        ...
        Date de demande <input  type="date" id="date_recharge_batterie" name="date" min ='<?php echo date('Y-m-d');?>' name="dateDemande" value="<?php echo $row['DATE_DEMANDE'] ?>"><br>
        <div class="error-message" id="date_recharge_batterie-error-message"></div>
        Localisation d'intervention<input type="text" id="localisation_recharge_batterie" name="lieu"value="<?php echo $row['LIEU'] ?>"><br>
        <div class="error-message" id="localisation_recharge_batterie-error-message"></div>
        <input type='submit' name='editBatterie' name="submit_recharge_batterie" value="Valider"class="submits">
      </form>
      <?php
      }
      ?>
